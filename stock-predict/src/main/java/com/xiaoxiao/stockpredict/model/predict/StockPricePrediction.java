...
//        String symbol = "GOOG"; // 股票名称
        String file = "D:\\code\\stock-prediction\\stock-backend\\src\\main\\resources\\demo.csv";
        ...
        File locationToSave = new File("stock-predict/src/main/resources/StockPriceLSTM_".concat(String.valueOf(category)).concat(".zip"));
